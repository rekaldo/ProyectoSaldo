...
public class CDT {
	...
	public String toString() {
		return "CDT{" + "idInversion=" + idInversion + ", idCuenta=" + idCuenta + ", fechaApertura=" + fechaApertura
				+ ", interesesMensuales=" + interesesMensuales + ", valorInversion=" + valorInversion + ", estado="
				+ estado + '}' + '\n';
	}
	...
	public CDT(int idInversion, int idCuenta, LocalDate fechaApertura, double interesesMensuales, double valorInversion,
			String estado) {
